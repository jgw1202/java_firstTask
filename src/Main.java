public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            double firstNum = inputHandler.getDoubleInput("첫 번째 숫자를 입력하세요: ");
            double secondNum = inputHandler.getDoubleInput("두 번째 숫자를 입력하세요: ");
            ...
            if ((arithmeticSymbol.equals("/") || arithmeticSymbol.equals("%")) && secondNum == 0) {
                ...
                secondNum = inputHandler.getDoubleInput("두 번째 숫자를 입력하세요: ");
            }
